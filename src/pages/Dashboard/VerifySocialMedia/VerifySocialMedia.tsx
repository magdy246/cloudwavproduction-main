...
export default function VerifySocialMedia() {
  ...
  const {
    ...
    queryKey: ["verify-social-media"],
    queryFn: () =>
      axiosServices.get("services/type/verify social media accounts"),
  ...
  return (
    <div>
      <TableOfContent
        ...
        title={t("dashboard.navLinks.verifySocialMediaAccounts")}
